...
export interface ObjectAccessGroup {
  ...
  // For MESSAGE_PARTICIPANT, this is the messageId that determines access
  id: string;
}
...
export interface ObjectAclPolicy {
  owner: string; // userId (coach) or clientId
...
// For message attachments: both coach and the client in the message can access
class MessageParticipantAccessGroup extends BaseObjectAccessGroup {
  constructor(id: string) {
    super(ObjectAccessGroupType.MESSAGE_PARTICIPANT, id);
  }
